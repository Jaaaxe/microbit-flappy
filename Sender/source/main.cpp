...
Bird bird = Bird(1, 4);  // The bird object
...
/**
     * Handle the Button A press on the mirobit
     * Will move the bird up by one LED
     * @param MicroBitEvent
     * @return Void
     */
...
/**
     * Handle the Button B press on the mirobit
     * Will move the bird down by one LED
     * @param MicroBitEvent
     * @return Void
     */
